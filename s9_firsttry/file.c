...
char *get_content(int fd_input, struct stat entryArray, char *inp_dir, char*out_dir) {
    // citim tot continutul fisierului in buffer
    char buffer[4096];
    int bytes_read = read(fd_input, buffer, sizeof(buffer));
